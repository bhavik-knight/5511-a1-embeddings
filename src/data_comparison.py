...
def main() -> None:
    ...
    print(f"✓ Generated and saved {len(new_embeddings)} embeddings to embeddings_modified.json")
    ...
    try:
        ...
        print("You can create one by copying embeddings.json to embeddings_baseline.json")
        return
    ...
    if results:
        ...
        print(f"\nInterpretation:")
        print(f"  - Unchanged sentences should have similarity ≈ 1.0 (perfect match)")
        print(f"  - Minor changes (synonyms) should have high scores (0.70-0.90)")
        print(f"  - Major changes (antonyms) should have lower scores (0.40-0.70)")
